...
class GildedRoseTest {
    ...
    public void qualityDecreaseByOne() {
        Item item = createAndUpdate(1,15, "foo");
        assertEquals(14, item.quality);
    }

    @Test
    public void agedBrieQualityIncreseByOne(){
        Item item = createAndUpdate(0,15, "Aged Brie");
        assertEquals(17, item.quality);
    }

    @Test
    public void BackstagePassQualityLost(){
        Item item = createAndUpdate(0,15,"Backstage passes to a TAFKAL80ETC concert");
        assertEquals(0, item.quality);
    }

    @Test
    public void SulfurasQualityDontChange(){
        Item item = createAndUpdate(0,15,"Sulfuras, Hand of Ragnaros");
        assertEquals(15, item.quality);
    }

    @Test
    public void itemQualityDecreases(){
        Item item = createAndUpdate(0,10,"foo");
